            ...
            {!uploadedImage ? (
              <div className="flex min-h-[500px] items-center justify-center">
                <div className="w-full max-w-2xl">
                  {isUploading ? (
                    <div className="border-border from-muted/50 via-background to-muted/30 relative overflow-hidden rounded-2xl border bg-linear-to-br p-6 text-center shadow-xl sm:p-12">
                      <div className="from-primary/5 to-primary/10 absolute inset-0 bg-linear-to-br"></div>
                    ...
                    <div className="group border-border from-muted/30 via-background to-muted/50 hover:border-primary/50 hover:bg-muted/40 relative overflow-hidden rounded-2xl border-2 border-dashed bg-linear-to-br p-6 text-center transition-all duration-300 hover:shadow-xl sm:p-12">
                      {/* Background decoration */}
                      <div className="from-primary/5 to-primary/10 absolute inset-0 bg-linear-to-br opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
                  ...
                  <Card className="shadow-lg">
                    <CardContent className="p-2 sm:p-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="rounded-lg border border-green-200 bg-linear-to-r from-green-50 to-emerald-50 p-2">
                        ...
                        <div className="grid gap-2 border-t pt-2 sm:grid-cols-2">
                          ...
                          {transformations.length > 0 && (
                            <Button
                              ...
                              size="sm"
                              className="h-7 gap-1 bg-linear-to-r from-blue-600 to-purple-600 px-2 hover:from-blue-700 hover:to-purple-700"
                            >
          ...
          {isLoadingProjects ? (
            ...
            <div className="mb-12">
                ...
                {userProjects.slice(0, 12).map((project, _index) => (
                  ...
                  >
                    <div className="relative aspect-square overflow-hidden rounded-2xl border-2 border-gray-200 bg-white shadow-lg transition-all duration-500 hover:-translate-y-2 hover:border-blue-300 hover:shadow-2xl">
                      ...
                      <div className="pointer-events-none absolute inset-0 bg-linear-to-br from-blue-500/0 to-purple-600/0 transition-all duration-500 group-hover:from-blue-500/20 group-hover:to-purple-600/20"></div>
                      ...
                      <div className="relative h-full w-full overflow-hidden">
                        ...
                        <div className="pointer-events-none absolute inset-0 -translate-x-full bg-linear-to-r from-transparent via-white/20 to-transparent opacity-0 transition-transform duration-1000 group-hover:translate-x-full group-hover:opacity-100"></div>
                      </div>

                      {/* Content overlay */}
                      <div className="pointer-events-none absolute inset-x-0 bottom-0 translate-y-2 transform bg-linear-to-t from-black/80 via-black/50 to-transparent p-4 transition-transform duration-300 group-hover:translate-y-0">
                      ...
                      {/* Corner accent */}
                      <div className="absolute top-0 right-0 h-0 w-0 border-t-20 border-l-20 border-t-blue-500 border-l-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              {userProjects.length > 12 && (
                <div className="mt-8 text-center">
                  <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-linear-to-r from-blue-50 to-purple-50 px-6 py-3">
            ...
            <div className="py-16 text-center">
              <div className="relative mx-auto mb-8">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div
                    className="h-24 w-24 animate-pulse rounded-full bg-linear-to-br from-blue-200 to-purple-200"
